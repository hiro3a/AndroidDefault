...
* [Java™ Platform, Standard Edition 7 API 仕様](http://docs.oracle.com/javase/jp/7/api/)

# API
* [Google Play Services](https://developers.google.com/android/)

# Android Studio
* [Android Studio Project Site](http://tools.android.com/download/studio)
...
# セキュリティ
* [Android アプリのセキュア設計●セキュアコーディングガイド](http://www.jssec.org/dl/android_securecoding.pdf)

# YouTube
* [Android Developers](https://www.youtube.com/user/androiddevelopers/)
* [DroidKaigi](https://www.youtube.com/channel/UCgK6L-PKx2OZBuhrQ6mmQZw)

# Qiita記事
* [Android開発のマイベストプラクティス](http://qiita.com/k-yamada@github/items/08fee683b372def7e769)
* [colors.xmlマイベストプラクティス](http://qiita.com/konifar/items/68f196dc7acacfcf40cf)